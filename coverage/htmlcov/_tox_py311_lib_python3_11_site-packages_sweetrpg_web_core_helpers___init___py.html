...
<head>
    ...
    <title>Coverage for .tox/py311/lib/python3.11/site-packages/sweetrpg_web_core/helpers/__init__.py: 67%</title>
...
<div id="header">
    <div class="content">
        <h1>Coverage for <b>.tox/py311/lib/python3.11/site-packages/sweetrpg_web_core/helpers/__init__.py</b> :
...
<div id="source">
    ...
    <p id="t3" class="run"><span class="n"><a href="#t3">3</a></span><span class="t"><span class="str">"""Health endpoints.</span>&nbsp;</span><span class="r"></span></p>
